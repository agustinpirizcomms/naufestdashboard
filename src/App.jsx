...
const EventDashboard = () => {
    ...
    // 1. CONEXIÓN Y ESTADO: Fetch de datos desde Sheetson
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            // Ordenar cronológicamente por hora_inicio (ASC)
    ...
    // 2. SISTEMA DE VISTAS INTERCAMBIAILES: Filtrado de datos
    ...
    // 3. ESTADOS VISUALES REACTIVOS: Mapeo de estilos según el estado
    ...
    if (error) return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50">
            <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-red-100 text-center">
                ...
                <button
                    onClick={fetchData}
                    className="w-full py-3 px-6 bg-indigo-600 text-white font-bold rounded-xl shadow-lg active:scale-95 transition-all font-montserrat"
                >
                    Reintentar Conexión
                </button>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h1 className="text-3xl font-black tracking-tight text-slate-900">
                            NAufest <span className="text-indigo-600">2026</span>
                        </h1>
                        <p className="text-slate-500 text-sm font-medium uppercase tracking-wider">Command Center & Schedule</p>
                    </div>
                ...
                {filteredData.length === 0 ? (
                    ...
                    <div className="animate-in fade-in duration-500">
                        {view === 'public' ? (
                            ...
                            /* --- VISTA STAFF (Tabla de Producción) --- */
